...
import com.ufpa.acc.repository.UsuarioRepository;
...
/**
 * REST controller for managing {@link com.ufpa.acc.domain.Usuario}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Usuario> result = usuarioRepository
            ...
            .map(existingUsuario -> {
                ...
                if (usuario.getUltimoAcesso() != null) {
                    existingUsuario.setUltimoAcesso(usuario.getUltimoAcesso());
                }
